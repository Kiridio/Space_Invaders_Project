...
var mainloop1: AudioStream = load("res://Assets/Music/MainLoop1.wav")
var mainloop2: AudioStream = load("res://Assets/Music/MainLoop2.wav")
var deathloop: AudioStream = load("res://Assets/Music/DeathLoop.wav")
var toloop2: AudioStream = load("res://Assets/Music/TransitionToLoop2.wav")
var ending: AudioStream = load("res://Assets/Music/Ending.wav")
var start: AudioStream = load("res://Assets/Music/Start.wav")
var die: AudioStream = load("res://Assets/Music/Die.wav")
var queue = []


func AddToQueue(audiosource: AudioStream):
	queue.append(audiosource)


func PlayOnLoop(audiosource: AudioStream):
	musicplayer.stream = audiosource
...
func _ready():
	...
	AddToQueue(mainloop1)
	PlayOnLoop(mainloop1)
...
func on_game_lost():
	...
	AddToQueue(deathloop)
	PlayOnLoop(deathloop)
...
func _on_music_player_finished():
	var currentaudio = queue[0]
	if queue.size() > 1 :
		PlayOnLoop(queue[1])
		queue.erase(currentaudio)
	else:
		PlayOnLoop(currentaudio)


func _on_spawn_timer_timeout():
	queue.append(toloop2)
	queue.append(mainloop2)
